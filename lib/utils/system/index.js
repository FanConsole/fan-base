...
const getSystemInfo = () => __spreadProps(__spreadValues({}, (0, import_byn_utils.getSystemInfo)()), {
  statusBarHeight: 0,
  navBarHeight: 44
});
const isMpWeixinWeb = () => {
  ...
  return (0, import_byn_utils.getSystemInfo)().isWeixin && ua.includes("miniProgram");
};
const isDevPackage = () => {
